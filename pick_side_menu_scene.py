...
def pick_side_menu_scene(engine: Engine) -> None:
    ...
    create_background(
            em,
            assets,
            "IMAGE_PICK_SIDE_MENU_BACKGROUND"
            )
    cursor = create_cursor(em, pg.Vector2(2, 4))
    ...
    control_system = MenuControlSystem(start_scene.context(), 6, 4)
